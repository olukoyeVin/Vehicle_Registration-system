  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../../dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Hezron</span>
    </a>
...
<!-- php code to fetch users list and display in data table -->
<?php
        $host = "localhost";
        $username = "";
        $password = "";
        ...
        $execute = mysqli_query($conn , $query_users);
      ...
      <table class="table">
        ...
        <tbody>
          ...
          if(mysqli_num_rows($execute) > 0) {
            while($user_data = mysqli_fetch_assoc($execute)){
          ...
          <tr>
            ...
            <td>*********</td>
            <td>2023-03-01 10:23:45</td>
            <td>2023-03-15 14:35:21</td>
            <td>
